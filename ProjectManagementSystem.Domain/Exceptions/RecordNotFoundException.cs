...
namespace ProjectManagementSystem.Domain.Exceptions
{
    ...
    public sealed class RecordNotFoundException : Exception
    {
        ...
        /// </see> that contains contextual information about the source or destination.</param>
        private RecordNotFoundException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
